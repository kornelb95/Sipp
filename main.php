...
if(isset($_POST['addtocart'])) {
    ...
    $productsArray['volume_id'] = Volume::findById(VolumesPrices::findVolumeIdByPriceAndPriceId($product->price_id, $_POST['price'])->volume_id)->id;
...
<?php require_once __DIR__ . '/includes/navbar_log.php'; ?>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div id="carouselLimittedContainer" class="col-lg-4">
